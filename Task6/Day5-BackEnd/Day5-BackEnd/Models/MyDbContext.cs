...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD797C9944EC3");

            entity.HasIndex(e => e.UserId, "UQ__Carts__1788CCAD56E3689D").IsUnique();
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__CartItem__488B0B2A8DA09807");

            entity.HasIndex(e => new { e.CartId, e.ProductId }, "UQ__CartItem__9AFC1BF88187BF1A").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BACA31052");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED9B7D9D2C");
